...
% Datos de portada
\title{Asistente de Programción en lenguaje C }
...
\noindent D. Carlos Pardo Aguilar, profesor del departamento de nombre departamento, área de nombre área.

\noindent Expone:

\noindent Que el alumno D. Rubén Marcos González, con DNI dni, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado título de TFG. 
